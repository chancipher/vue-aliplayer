...
Component.options.__file = "/Users/cipher/Work/OTHER/vue-aliplayer/src/VueAliplayer.vue"
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
      ...
      if (_this.scriptTagStatus === 2 && (_this.instance === null || _this.reloadPlayer)) {
        ...
        _this.$nextTick(function () {
          ...
          _this.instance.on("ready", function () {
            _this2.$emit("ready", _this.instance);
          });

          _this.instance.on("play", function () {
            _this2.$emit("play", _this.instance);
          });

          _this.instance.on("pause", function () {
            _this2.$emit("pause", _this.instance);
          });

          _this.instance.on("ended", function () {
            _this2.$emit("ended", _this.instance);
          });

          _this.instance.on("liveStreamStop", function () {
            _this2.$emit("liveStreamStop", _this.instance);
          });

          _this.instance.on("m3u8Retry", function () {
            _this2.$emit("m3u8Retry", _this.instance);
          });

          _this.instance.on("hideBar", function () {
            _this2.$emit("hideBar", _this.instance);
          });

          _this.instance.on("waiting", function () {
            _this2.$emit("waiting", _this.instance);
          });

          _this.instance.on("snapshoted", function () {
            _this2.$emit("snapshoted", _this.instance);
          });
     ...
     *目前只支持H5播放器。
     ...
     暂不支持直播rtmp流切换。
     */
    replayByVidAndPlayAuth: function replayByVidAndPlayAuth(vid, accId, accSecret, stsToken, authInfo, domainRegion) {
     ...
     * @param playauth 播放权限
     */
    replayByVidAndAuthInfo: function replayByVidAndAuthInfo(vid, playauth) {
...
// imports
exports.push([module.i, "@import url(//g.alicdn.com/de/prismplayer/2.9.3/skins/default/aliplayer-min.css);", ""]);
...
var update = __webpack_require__(11)("4c6d9d42", content, false);
